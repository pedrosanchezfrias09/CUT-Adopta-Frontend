...
function obtenerPerro(perroId) {
    if (perroId) {
        ...
        fetch(`https://cut-adopta-backend-perritos.onrender.com/ObtenerPerroPorId/${perroId}`)
...
function eliminarPerrito() {
    ...
    fetch(`https://cut-adopta-backend-perritos.onrender.com/perros/${perroId}`, {
        method: "DELETE"
    })
    .then(response => {
        if (!response.ok) {
...
function actualizarPerrito() {
    ...
    fetch(`https://cut-adopta-backend-perritos.onrender.com/ActualizarPerro/${perroId}`, {
        method: "PUT",
        headers: {
